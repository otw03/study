...
class CookieHelper {
    ...
    setCookie(name, value, options = {}) {
        ...
        // expiress 값이 Date 클래스의 객체라면 UTCString 타입으로 변환함. (max-age가 있으면 사용 안해도 됨)
        ...
        for(let optionKey in options) {
            ...
            // 삭제를 위해서 0으로 시간을 설정하면 논리값으로 처리되는 경우가 있어서 넣음.
            if(optionValue !== true) {
     ...
     */
    getCookie(name) {
        // 주어진 이름에 대해 ": naem=<value>" 패턴을 찾아 <value> 부분만 반환함
